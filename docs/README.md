...
| **Decisions** | [../ADR/](../ADR/) — Architecture Decision Records (ADR-0000 … ADR-0017); [ADR-0000](../ADR/ADR-0000-decision-records-and-source-of-truth.md) defines what is authoritative |
