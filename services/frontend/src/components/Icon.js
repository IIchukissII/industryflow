...
const FILLED = new Set(['play', 'star', 'dot']);

export default function Icon({ name, size = 16, color = 'currentColor', strokeWidth = 2, style, className, title }) {
